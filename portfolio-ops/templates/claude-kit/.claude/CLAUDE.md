...
1. **Identify the project** from `.claude/PORTFOLIO.md` (repo root) (match on repo path, Vercel project, Supabase ref, or domain). If it's unclear, ask **exactly one** question to resolve it, then proceed.
